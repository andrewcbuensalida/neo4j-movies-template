              ...
              <div className="small-12 medium-9 columns nt-person-main">
                <div>
                  <div className="nt-box">
                    <div className="nt-box-title">Bio</div>
                  </div>

                  <div className="nt-box">
                    <div className="nt-box-title">Related People</div>
  ...
  renderRelatedMovies(sectionTitle, movies) {
    ...
    return (
      <div className="row nt-person-movies">
        <div className="large-12 columns">
          <div className="nt-box">
            <div className="nt-box-title">{sectionTitle}</div>
            <Carousel>
              {movies.map((m) => {
                return (
                  <div key={m.id}>
                    ...
                    <div className="nt-carousel-movie-title">
                      <Link to={`/movie/${m.id}`}>{m.name}</Link>
                    </div>
                    {m.role ? (
