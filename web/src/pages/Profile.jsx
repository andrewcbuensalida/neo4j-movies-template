    ...
    return (
      <div className="nt-profile">
        ...
        <div className="row">
          <div className="small-12 columns">
            <div className="nt-box">
              <div className="nt-box-title">My Profile</div>
        ...
        <div className="row">
          <div className="small-12 columns">
            <div className="nt-box">
              <div className="nt-box-title">My rated movies</div>
                      ...
                      <div key={movie.id}>
                        <Link to={`/movie/${movie.id}`}>
                          <img
                            ...
                            className="nt-profile-movie-cover"
                            alt=""
                          />
                        </Link>
        ...
        <div className="row">
          <div className="small-12 columns">
            <div className="nt-box">
              <div className="nt-box-title">Recommended for me</div>
