...
export const PROFILE_MOVIE_DELETE_RATING_SUCCESS =
  "PROFILE_MOVIE_DELETE_RATING_SUCCESS";
export const PROFILE_MOVIE_DELETE_RATING_FAILURE =
  "PROFILE_MOVIE_DELETE_RATING_FAILURE";

export const PROFILE_GET_RECOMMENDATIONS = "PROFILE_GET_RECOMMENDATIONS";
export const PROFILE_GET_RECOMMENDATIONS_SUCCESS =
  "PROFILE_GET_RECOMMENDATIONS_SUCCESS";
export const PROFILE_GET_RECOMMENDATIONS_FAILURE =
