...
!(function () {
    ...
    d = function (a, b) {
      if (a && "object" == typeof a) {
        ...
        if (
          ...
          for (c in a) if (a.hasOwnProperty(c) && b(c, a[c]) === !1) return;
      }
    },
    e = function (a, b) {
  ...
  (f.prototype = {
            ...
            (d.onreadystatechange = function () {
              if (4 == d.readyState) {
                ...
                try {
                  ...
                  throw (
                    (window.console.log(i), "Failed to parse external ref " + a)
                  );
                }
            ...
            a.minLength &&
              ...
              k.push({
                ...
                message: this.translate(
                  1 === a.minLength ? "error_notempty" : "error_minLength",
                  [a.minLength]
                ),
              }),
            a.pattern &&
        ...
        for (a in this.cached_editors)
          this.cached_editors.hasOwnProperty(a) &&
            ...
            d <= this.schema.minProperties
              ? ((this.addproperty_checkboxes[a].disabled =
    ...
    (f.defaults.editors.select = f.AbstractEditor.extend({
      setValue: function (a, b) {
        ...
        this.enum_values.indexOf(c) < 0 && (c = this.enum_values[0]),
          this.value !== c &&
            ((this.input.value =
              this.enum_options[this.enum_values.indexOf(c)]),
    ...
    (f.defaults.editors.multiselect = f.AbstractEditor.extend({
        ...
        if (
          ...
          for (
            ...
            (this.inputs[this.option_keys[a]] = this.theme.getCheckbox()),
              (this.select_options[this.option_keys[a]] =
      ...
      setValue: function (a, b) {
        ...
        for (
          a = a || [],
            "object" != typeof a ? (a = [a]) : Array.isArray(a) || (a = []),
            c = 0;
          c < a.length;
          c++
        )
  ...
  (f.AbstractTheme = a.extend({
    ...
    (f.defaults.themes.jqueryui = f.AbstractTheme.extend({
      ...
      markTabActive: function (a) {
        a.className =
          a.className.replace(/\s*ui-widget-header/g, "") + " ui-state-active";
      },
      markTabInactive: function (a) {
        a.className =
          a.className.replace(/\s*ui-state-active/g, "") + " ui-widget-header";
      },
    })),
